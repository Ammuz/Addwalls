            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Add Dividend</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('dividend/save') ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="dividend" name="dividend" pattern="^\d+(\.\d+)?%?$" title="Please enter a valid dividend value in percentage format (e.g., 25%, 50.5%, 100%, etc.)" required>
                                    </div>
                                </div>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Create Dividend</button>
                            </div>
                        </form>
                    </div>
                </div>
