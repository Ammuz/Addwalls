<div class="header">
    <div class="header-left">
        <a href="index-2.html" class="logo">
            ...
            <span><i class="fa fa-user"></i> Agent</span>
        </a>
    </div>
    ...
    <ul class="nav user-menu float-right">
        ...
        <li class="nav-item dropdown has-arrow">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="<?= site_url('agent/logout') ?>">Logout</a>
            </div>
        </li>
    </ul>
            ...
            <ul>
                ...
                <li>
                    ...
                    <!-- <li><a href="attendance.html">Attendance</a></li>
                        ...
                        -->
                        <li class="">
                            <a href="<?=site_url('agent/dashboard');?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                        <li class="">
                            <a href="<?=site_url('agent/applications');?>"><i class="fa fa-dashboard"></i> <span>Applications</span></a>
                        </li>
