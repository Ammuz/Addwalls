            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Staff Ctegory</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="<?=site_url('Addwalls/staffcategory')?>"
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table datatable mb-0" id="myTable">
                                ...
                                <tbody>
                                    <?php 
                                  $i=1; if($staffcategorys): ?>
                                    <?php foreach($staffcategorys as $staffcategory): ?>
                                    <tr>
                                        <td><?=$i;?></td>

                                        <td><?=$staffcategory['Staff_type']?></td>
                                        <td><?=$staffcategory['StaffKey']?></td>
                                        <td><?=$staffcategory['Description']?></td>
                                        <td><?=$staffcategory['Status']?></td>
                                        <td>
                                            <a href="<?= base_url('edit_staffcategorys/edit/'.$staffcategory['Staff_id']) ?>"
                                                class="editBtn"><button class="edit-button" ><i class="fas fa-edit"></i></button></a>
                                            <a href="<?= base_url('staff/delete/'.$staffcategory['Staff_id']) ?>"
