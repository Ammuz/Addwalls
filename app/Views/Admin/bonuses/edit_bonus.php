            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit Bonus</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('bonus/update/'.$bonuses['bonus_id']) ?>" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="bonus_id" value="<?=$bonuses['bonus_id']?>">

                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Bonus in Percentage <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="bonuspercentage"
                                            value="<?=$bonuses['bonus_in_percenatage']?>" required>
                                    </div>
                                </div>
