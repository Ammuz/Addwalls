            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit StaffCategory</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('staff/update/'.$staffcategorys['Staff_id']) ?>" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="categoryId" value="<?=$staffcategorys['Staff_id']?>">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="staff_type"
                                            value="<?=$staffcategorys['Staff_type']?>" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Descriptions</label>
                                        <textarea class="form-control" rows="3" cols="30" name="description" value=""
                                            ><?=$staffcategorys['Description']?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Staff Key <span class="text-danger"></span></label>
                                        <input class="form-control" type="text" name="staffkey"
                                            value="<?=$staffcategorys['StaffKey']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-check-input" type="radio" name="status" id="patient_active"
                                            value="active" <?php if ($staffcategorys['Status'] == "active")  echo "checked"?>>
                                ...
                                <input class="form-check-input" type="radio" name="status" id="patient_inactive"
                                            value="In-active"<?php if ($staffcategorys['Status'] == "In-active")  echo "checked"?>>
