						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0" id="myTable">
								...
								<tbody>
									...
									<tr>
                                    <td><?= $shareholders['referalcode'] ?></td>
                                    <td><?= $shareholders['Name'] ?></td>
<td><?= $shareholders['adharno'] ?></td>
<td><?= $shareholders['panno'] ?></td>
<td><?= $shareholders['Mobile'] ?></td>
<td><?= $shareholders['Email'] ?></td>
<td><?= $shareholders['Paddress'] ?></td>
