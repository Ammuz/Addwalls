<div class="header">
    <div class="header-left">
        <a href="index-2.html" class="logo">
            ...
            <span><i class="fa fa-user"></i>Tertiary Manager</span>
        </a>
    </div>
    ...
    <ul class="nav user-menu float-right">
        ...
        <li class="nav-item dropdown has-arrow">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="<?= site_url('tertiarymanager/logout') ?>">Logout</a>
            </div>
        </li>
    </ul>
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="menu-title">Main</li>
                        ...
                        <li class="">
                            <a href="<?=site_url('tertiarymanager/dashboard');?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                          <li>
