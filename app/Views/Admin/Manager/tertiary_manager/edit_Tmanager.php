...
<body>
    <div class="main-wrapper">
        <?php echo view('Admin/Manager/sidebar'); ?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit Tertiary Manager</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('tertiary_manager/update/'.$tmanager['Tmanager_id']) ?>" method="post"
                            enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group">
                                    <input type="hidden" name="categoryId" value="<?=$tmanager['Tmanager_id']?>">
                                </div>
                                <!-- <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Manager Code <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" value="<?=$tmanager['tmanager_code']?>"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?=$tmanager['username']?>"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?=$tmanager['password']?>"
                                            name="password">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?=$tmanager['email']?>" type="email"
                                            name="email">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" cols="30" name="caddress"
                                            required><?=$tmanager['Caddress']?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" cols="30" name="paddress"
                                            required><?=$tmanager['Paddress']?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Date of Birth </label>
                                        <input class="form-control" value="<?=$tmanager['Dob']?>" type="date"
                                            name="birthday">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Nominee </label>
                                        <input class="form-control" value="<?=$tmanager['Nominee']?>" type="text"
                                            name="nominee">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?=$tmanager['Relationship_with_nominee']?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Father</label>
                                        <input class="form-control" value="<?=$tmanager['Father']?>" type="text"
                                            name="father">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Mother</label>
                                        <input class="form-control" value="<?=$tmanager['Mother']?>" type="text"
                                            name="mother">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?=$tmanager['Education']?>" type="text"
                                            name="education">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label> Aadhar Number : <span style="color:red">*</span></label>
                                    <input type="text" value="<?=$tmanager['Adhar_cardno']?>" name="adharno" id="adharno"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="<?=$tmanager['Pancardno']?>" name="panno"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <?php if($tmanager['Adhar_card_front']!=null)
                                        {
                                            $pdf='/adhar/'.$tmanager['Adhar_card_front'];
                                        }
                                        else {
                                            $pdf="No data";
                                        }
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <?php if($tmanager['Adhar_card_back']!=null)
                                        {
                                            $pdf='/adhar/'.$tmanager['Adhar_card_back'];
                                        }
                                        else {
                                            $pdf="No data";
                                        }
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <?php if($tmanager['Pancard_front']!=null)
                                        {
                                            $pdf='/pan/'.$tmanager['Pancard_front'];
                                        }
                                        else {
                                            $pdf="No data";
                                        }
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Pincode</label>
                                        <input class="form-control" type="text" name="pin" value="<?=$tmanager['Pin']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="patient_active"
                                            value="active" <?php if ($tmanager['Status'] == "active")  echo "checked"?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="patient_inactive"
                                            value="In-active"
                                            <?php if ($tmanager['Status'] == "In-active")  echo "checked"?>>
