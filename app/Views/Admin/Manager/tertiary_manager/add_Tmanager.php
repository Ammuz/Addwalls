...
<body>
    ...
    <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('tertiary_manager/save') ?>" method="post"id="registrationForm" enctype="multipart/form-data">
                            <div class="row">
                            <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Tertiary Manager Code </label>
                                        <input type="hidden" name="<?=csrf_token()?>" value="<?= csrf_hash() ?>" id="msg_csrf"/>
                                        <?php 
                                  if($pts): ?>
                                    <?php foreach($pts as $Employee): ?>
                                            <input class="form-control" type="text" name="tmanager_id" hidden value="<?=$Employee['tmanager_code']+1?>">
                                            <input class="form-control" type="text" value="TMNR0<?=$Employee['tmanager_code']+1?>" name="tmanagercode" readonly="">
                                            <?php  endforeach; ?>
                                        <?php  endif; ?>
                                    </div>
                                </div>
...
<select id="districtDropdown"></select> -->
                                ...
                                <div class="m-t-20 text-center">
                                    <button class="btn btn-primary submit-btn">Create Manager</button>
                                </div>
                        </form>
                    </div>
                </div>
