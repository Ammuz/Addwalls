    ...
    <ul class="nav user-menu float-right">
        ...
        <li class="nav-item dropdown has-arrow">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="<?= site_url('manager/logout') ?>">Logout</a>
            </div>
        </li>
    </ul>
            ...
            <ul>
                ...
                <li>
                    ...
                    <!-- <li><a href="attendance.html">Attendance</a></li>
                        ...
                        -->
                        <li class="">
                            <a href="<?=site_url('manager/dashboard');?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                ...
                <li>
                    <a href="<?=site_url('Addwalls/Tertiarymanager');?>"><i class="fa fa-user"></i> <span>Tertiary Manager</span></a>
                </li>
