    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('manager/update/'.$manager['manager_id']) ?>" method="post"
                            enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group">
                                    <input type="hidden" name="categoryId" value="<?=$manager['manager_id']?>">
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Manager Code <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" value="<?=$manager['manager_code']?>"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?=$manager['username']?>"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?=$manager['password']?>"
                                            name="password">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?=$manager['email']?>" type="email"
                                            name="email">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" cols="30" name="caddress"
                                            required><?=$manager['Caddress']?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" cols="30" name="paddress"
                                            required><?=$manager['Paddress']?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Date of Birth </label>
                                        <input class="form-control" value="<?=$manager['Dob']?>" type="date"
                                            name="birthday">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Nominee </label>
                                        <input class="form-control" value="<?=$manager['Nominee']?>" type="text"
                                            name="nominee">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?=$manager['Relationship_with_nominee']?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Father</label>
                                        <input class="form-control" value="<?=$manager['Father']?>" type="text"
                                            name="father">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Mother</label>
                                        <input class="form-control" value="<?=$manager['Mother']?>" type="text"
                                            name="mother">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?=$manager['Education']?>" type="text"
                                            name="education">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label> Aadhar Number : <span style="color:red">*</span></label>
                                    <input type="text" value="<?=$manager['Adhar_cardno']?>" name="adharno" id="adharno"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="<?=$manager['Pancardno']?>" name="panno"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <?php if($manager['Adhar_card_front']!=null)
                                        {
                                            $pdf='/adhar/'.$manager['Adhar_card_front'];
                                        }
                                        else {
                                            $pdf="No data";
                                        }
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <?php if($manager['Adhar_card_back']!=null)
                                        {
                                            $pdf='/adhar/'.$manager['Adhar_card_back'];
                                        }
                                        else {
                                            $pdf="No data";
                                        }
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <?php if($manager['Pancard_front']!=null)
                                        {
                                            $pdf='/pan/'.$manager['Pancard_front'];
                                        }
                                        else {
                                            $pdf="No data";
                                        }
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Pincode</label>
                                        <input class="form-control" type="text" name="pin" value="<?=$manager['Pin']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="patient_active"
                                            value="active" <?php if ($manager['Status'] == "active")  echo "checked"?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="patient_inactive"
                                            value="In-active"
                                            <?php if ($manager['Status'] == "In-active")  echo "checked"?>>
