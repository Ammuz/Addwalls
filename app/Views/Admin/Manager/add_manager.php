...
<body>
    ...
    <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?=site_url('manager/save') ?>" method="post"id="registrationForm" enctype="multipart/form-data">
                            <div class="row">
                            <div class="col-sm-12">
                                  ...
                                  if($pt): ?>
                                    <?php foreach($pt as $Employee): ?>
                                            <input class="form-control" type="text" name="manager_id" hidden value="<?=$Employee['manager_code']+1?>">
                                            <input class="form-control" type="text" value="MNR0<?=$Employee['manager_code']+1?>" name="managercode" readonly="">
                                            <?php  endforeach; ?>
                                        <?php  endif; ?>
                                    </div>
                                </div>
