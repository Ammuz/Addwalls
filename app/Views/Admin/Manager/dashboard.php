...
<body>
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="<?php echo base_url('/img/logo.png')?>" width="35" height="35" alt=""> <span>Preclinic</span>
				</a>
			</div>
    ...
    <script>
    // Check if the user is logged in (adjust the condition as per your actual implementation)
    if (!isLoggedIn) {
        window.location.replace('adminlogin'); // Redirect to login page
    }
</script>
