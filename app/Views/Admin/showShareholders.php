            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Shareholders</h4>
                    </div>
						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0" id="myTable">
                                ...
                                <?php foreach($shareholders as $shareholder): ?>
									<tr>
										 <td><?=$i;?></td> 
										<td><?=$shareholder->referalcode;?></td>
										<td><?=$shareholder->Name;?></td>
										<td><?=$shareholder->adharno;?></td>
										<td><?=$shareholder->panno;?></td>
                                        <td><?=$shareholder->Paddress;?></td>
                                        <td><?=$shareholder->Mobile;?></td>
										<td><?=$shareholder->Email;?></td>
                                        <td>
                                            <a href="<?= base_url('Applications/view/'.$shareholder->App_id);?>"
                                                class="editBtn"><button class="edit-button" ><i class="fas fa-eye"></i></button></a>
                                            <a href="<?= base_url('Applications/delete/'.$shareholder->App_id);?>"
